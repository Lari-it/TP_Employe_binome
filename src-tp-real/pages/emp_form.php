<?php
    ...
    $page_title = $editing ? "Modifier un employé" : "Ajouter un employé";
    $current_page = 'emp_form';
...
<?php if ($success) { ?>
    <div class="alert alert-success">
        Enregistré. <a href="fiche.php?emp_no=<?= urlencode($emp_no) ?>">Voir la fiche &rarr;</a>
    </div>
<?php } ?>
<?php if ($error !== '') { ?>
